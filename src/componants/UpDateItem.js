...
class UpDateItem extends Component {
    ...
    render() {
        return <div className="newItem">
            ...
            <h6> קטגוריות : </h6>
            {this.props.item.Category.map(i => <button name="Category" id={i} onClick={this.addToArry}>   לפני לחץ כדי לשמר  "{i}" היה  <i className="material-icons left">add</i> </button>)}
            ...
            <h6> מידות :</h6>
            {/* <br></br> */}
            {this.props.item.sizes.map(i => <button name="sizes" id={i} onClick={this.addToArry}> לפני לחץ כדי לשמר  "{i}" היה  <i className="material-icons left">add</i> </button>)}
