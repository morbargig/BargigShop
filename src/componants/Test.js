...
class Test extends Component {
    ...
    render() {
        return <div>
            <li class="product type-product post-3762 status-publish instock product_cat-111 has-post-thumbnail taxable shipping-taxable purchasable product-type-variable has-default-attributes">
                <div class="product-box-wrapper">
                    ...
                    <a href="https://www.purpleilat.co.il/product/%d7%a9%d7%9e%d7%9c%d7%aa-%d7%99%d7%95%d7%91%d7%9c/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link" title="שמלת יובל | צבעים חדשים" aria-label="שמלת יובל | צבעים חדשים">
                        ...
                        <img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/04/purple-501-404x604.jpg" class="attachment-prev-product size-prev-product" alt=""></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/07/IMG_20190715_144642-1-404x604.jpg" data-color-id="154" class="attachment-prev-product size-prev-product" style="display: none;" alt="שמלת יובל | צבעים חדשים"></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/07/IMG_20190715_142530-1-404x604.jpg" data-color-id="261" class="attachment-prev-product size-prev-product" style="display: none;" alt="שמלת יובל | צבעים חדשים"></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/07/IMG_20190715_145547-1-404x604.jpg" data-color-id="168" class="attachment-prev-product size-prev-product" style="display: none;" alt="שמלת יובל | צבעים חדשים"></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/07/IMG_20190715_141223-1-404x604.jpg" data-color-id="266" class="attachment-prev-product size-prev-product" style="display: none;" alt="שמלת יובל | צבעים חדשים"></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/07/IMG_20190715_143217-1-404x604.jpg" data-color-id="268" class="attachment-prev-product size-prev-product" style="display: none;" alt="שמלת יובל | צבעים חדשים"></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/07/IMG_20190715_145121-1-404x604.jpg" data-color-id="301" class="attachment-prev-product size-prev-product" style="display: none;" alt="שמלת יובל | צבעים חדשים"></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/04/purple-501-404x604.jpg" data-color-id="263" class="attachment-prev-product size-prev-product" style="display: none;" alt="שמלת יובל | צבעים חדשים"></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/04/purple-454-404x604.jpg" data-color-id="167" class="attachment-prev-product size-prev-product" style="display: none;" alt="שמלת יובל | צבעים חדשים"></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/04/purple-568-404x604.jpg" data-color-id="247" class="attachment-prev-product size-prev-product" style="display: none;" alt="שמלת יובל | צבעים חדשים"></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/04/purple-538-404x604.jpg" data-color-id="166" class="attachment-prev-product size-prev-product" style="display: none;" alt="שמלת יובל | צבעים חדשים"></img><img width="404" height="604" src="https://www.purpleilat.co.il/wp-content/uploads/2019/04/purple-503-404x604.jpg" class="hover-image" alt="שמלת יובל | צבעים חדשים"></img><h2 class="woocommerce-loop-product__title">שמלת יובל | צבעים חדשים</h2>
                        ...
                        <ul class="color-list">
                            ...
                            <li id="color-154" class="item-color">
                                ...
                                <button type="button" class="choose-color-btn trigger-prev-img-by-color" data-color-id="154" title="choose color" aria-label="choose color">
                                    <span class="color-box" style="background-color: #fa2fa9;"></span>
                                </button>
                            ...
                            <li id="color-268" class="item-color">
                                ...
                                <button type="button" class="choose-color-btn trigger-prev-img-by-color" data-color-id="268" title="choose color" aria-label="choose color">
                                    <span class="color-box" style={"background-color: #CF76AA;"}></span>
                                </button>
                            ...
                            <li id="color-301" class="item-color">
                                ...
                                <button type="button" class="choose-color-btn trigger-prev-img-by-color" data-color-id="301" title="choose color" aria-label="choose color">
                                    <span class="color-box" style="background-color: #6680A1;"></span>
                                </button>
                            ...
                            <li id="color-312" class="item-color">
                                ...
                                <button type="button" class="choose-color-btn trigger-prev-img-by-color" data-color-id="312" title="choose color" aria-label="choose color">
                                    <span class="color-box" style="background-color: #08176b;"></span>
                                </button>
                            ...
                            <li id="color-266" class="item-color">
                                ...
                                <button type="button" class="choose-color-btn trigger-prev-img-by-color" data-color-id="266" title="choose color" aria-label="choose color">
                                    <span class="color-box" style="background-color: #AC607C;"></span>
                                </button>
                            ...
                            <li id="color-261" class="item-color">
                                ...
                                <button type="button" class="choose-color-btn trigger-prev-img-by-color" data-color-id="261" title="choose color" aria-label="choose color">
                                    <span class="color-box" style="background-color: #171614;"></span>
                                </button>
                            ...
                            <li id="color-168" class="item-color">
                                ...
                                <button type="button" class="choose-color-btn trigger-prev-img-by-color" data-color-id="168" title="choose color" aria-label="choose color">
                                    <span class="color-box" style="background-color: #fff1c7;"></span>
                                </button>
