        ...
        return <div className="stores">
            ...
            {this.state.item ? this.state.item.map(i => <div className="details">
                <div className="flip-card-back">
                    <h2>{i.name}</h2>
                    <img className="busImg" src={this.state[i.name] !== undefined ? this.state[i.name] : i.image} alt={i.name}  ></img>
                    ...
                    {i.color !== undefined ?
                        <div >
                            <li id="color-154" className="item-color">
                                ...
                                <button id={i.id} name={i.name} value={i.image} onClick={this.colorImage} type="button" className="choose-color-btn " title="choose color" aria-label={`בחר צבע רגיל`}>
                                ...
                                <ul className="color-list">
                                    {Object.keys(i.color).map(o =>
                                        <li id="color-154" className="item-color">
                                            ...
                                            <button name={i.name} value={i.color[o]} onClick={this.colorImage} type="button" className="choose-color-btn " title="choose color" aria-label={`choose ${o} color`}>
                                                <span className="color-box"
                                                    style={{
                                                        backgroundColor: o,
                                                    }}
                    ...
                    <p> <a href="!#"> Description :  </a> {i.Description}  </p>
                    ...
                    <a href="!#"> Cell Me :</a>
                    {/* <a href="tel:+97252-861-2379"> <i className="fa fa-phone fa-fw"></i><span dir="ltr"> +972 52-861-2379</span> </a> */}
                    ...
                    <br></br><br></br>
                    <a href="!#">Email Me :</a>
                    {/* <a href="mailto:morbargig@gmail.com"><i className="fa fa-envelope-o fa-fw"></i> morbargig@gmail.com</a> */}
